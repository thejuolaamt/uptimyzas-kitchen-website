      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 reveal-on-scroll">
          <a
            ...
            className="group w-full sm:w-auto bg-[#27AE60] text-white font-medium px-8 py-4 rounded-full text-base hover:bg-[#219a52] transition-all duration-300 text-center flex items-center justify-center gap-2"
          >
            <svg
          ...
          <a
            href="/menu"
            className="w-full sm:w-auto bg-white text-[#8B1E1E] font-medium px-8 py-4 rounded-full text-base hover:bg-gray-100 transition-all duration-300 text-center"
          >
            See menu
          </a>
        </div>
