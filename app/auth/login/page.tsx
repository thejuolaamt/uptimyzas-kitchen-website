  ...
  return (
    <section className="pt-24 pb-16 min-h-screen bg-white">
      <div className="max-w-md mx-auto px-4">
        <h1 className="text-3xl font-bold text-[#2C2C2C] mb-2 text-center">Welcome back</h1>
        <p className="text-[#666666] text-center mb-8">Sign in to your account</p>
        ...
        <p className="text-[#666666] text-sm text-center mt-6">
          ...
          <Link href="/auth/signup" className="text-[#8B1E1E] font-semibold hover:underline">
            Create one
          </Link>
        </p>
      </div>
